...
if (!isset($this->subscribe2_options['public_email_type'])) {
	$this->subscribe2_options['public_email_type'] = 'full';
} // Default public email level

if (!isset($this->subscribe2_options['protected_email_type'])) {
	$this->subscribe2_options['protected_email_type'] = 'full';
} // Default protected email level

if (!isset($this->subscribe2_options['show_warning_message'])) {
	$this->subscribe2_options['show_warning_message'] = 'no';
} // Default protected email level
// End add
?>